...
describe("R5 xml to json", function()
    ...
    setup(function()
        ...
        patient_example_data = in_fhir_json("spec/R5/patient-example.xml",
          {file = true, fhirversion = "R5"})
...
describe("R5 json to xml", function()
    local positive_example, patient_example,
    positive_example_data, patient_example_data
    ...
    setup(function()
        ...
        positive_example_data = io.read("*a")
        patient_example_data = in_fhir_xml("spec/R5/patient-example.json",
          {file = true, fhirversion = "R5"})
    ...
    it("should have the same data", function()
        ...
        assert.same(
          cjson.decode(in_fhir_json(positive_example_data, {fhirversion = "R5"})),
          cjson.decode(in_fhir_json(patient_example_data, {fhirversion = "R5"})))
      end)
  end)
